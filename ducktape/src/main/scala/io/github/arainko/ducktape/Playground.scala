...
object newtypes {
  ...
  object Name {
    ...
    given refineName2: Accumulating[[A] =>> Either[List[String], A], String, Name] = 
      a => Left(::("WOOPS", Nil))
  }
  ...
  object Age {
    ...
    given refineAge2: Accumulating[[A] =>> Either[List[String], A], Int, Age] = a => Left(::("WOOPS2", Nil))
  }
}
...
object Playground extends App {
  ...
  summon[Accumulating[[A] =>> Either[List[String], A], Person2, Person3]]
